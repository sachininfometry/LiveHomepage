...
$capabilities = array(
	...
	array( 'icon' => 'chart', 'class' => 'is-connectivity', 'kicker' => 'Advanced Intelligence', 'title' => 'Advanced Analytics', 'copy' => 'Apply advanced, LLM-driven analysis to enterprise data to uncover patterns, key drivers, and deeper insights with business context beyond basic reporting, helping teams understand root causes, evaluate trends, and make faster, well-informed decisions.', 'benefits' => array( 'Detect patterns and important trends', 'Identify key drivers and root causes' ), 'tags' => array( 'LLM Insights', 'Business Context' ) ),
