...
$capabilities = array(
	array( 'icon' => 'chat', 'class' => 'is-natural-language', 'kicker' => 'Conversational Analytics', 'title' => 'Natural Language to SQL Engine', 'copy' => 'Conversa’s natural language to SQL engine converts business questions into optimized queries automatically. Explore any metric without SQL, reduce analyst dependency, accelerate insights, and simplify data workflows across teams effortlessly.', 'benefits' => array( 'Understand terminology, KPIs, and business logic', 'Generate optimized SQL on live enterprise data', 'Deliver context-rich insights without writing SQL' ), 'tags' => array( 'Advanced NLP', 'Less Analyst Work' ) ),
