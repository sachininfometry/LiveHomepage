...
$capabilities = array(
	...
	array( 'icon' => 'brain', 'class' => 'is-ai-insights', 'kicker' => 'AI Intelligence', 'title' => 'Multi-Model AI Analytics', 'copy' => 'Conversa supports Snowflake Cortex Agent, OpenAI, Gemini, and Claude, letting organizations choose the best AI model for accurate insights, reduced manual analysis, and streamlined data operations.', 'benefits' => array( 'Choose the right AI model', 'Analyze complex questions'), 'tags' => array( 'Multi-Model AI', 'Trusted Answers' ) ),
	...
	array( 'icon' => 'monitor', 'class' => 'is-monitoring', 'kicker' => 'Native Experience', 'title' => 'Native Desktop Application', 'copy' => 'Conversa is available as a native desktop application for macOS and Windows, providing enterprise teams with fast, secure access to conversational analytics and consistent, high-performance, AI-powered insights across devices every day.', 'benefits' => array( 'Use a native application', 'Work securely on desktop', 'Support Windows and macOS' ), 'tags' => array( 'Native Desktop', 'Secure Access' ) ),
	array( 'icon' => 'bolt', 'class' => 'is-automation', 'kicker' => 'Business Efficiency', 'title' => 'Cost Optimization & Faster Insights', 'copy' => 'Reduce reporting effort, eliminate analytics bottlenecks, and accelerate trusted decisions with AI-powered insights that optimize costs, simplify enterprise analytics, and improve business efficiency across teams through smarter data analysis daily.', 'benefits' => array( 'Reduce reporting effort', 'Remove analytics bottlenecks', 'Accelerate decisions' ), 'tags' => array( 'Cost Optimization', 'Faster Insights' ) ),
);
